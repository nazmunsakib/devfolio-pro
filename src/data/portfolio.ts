export const portfolioData = {
    name: "Nazmun Sakib",
    title: "WordPress Developer | Software Architect",
    ...
    projects: [
        ...
        },
        {
            ...
            description: "Custom WooCommerce solution with advanced filtering, subscription management, and integrated payment gateways processing 10k+ monthly transactions.",
            tech: ["WordPress", "WooCommerce", "PHP", "MySQL", "Stripe"],
            role: "Full-Stack Developer",
        ...
        },
        {
            ...
            description: "High-conversion landing page for a B2B SaaS company featuring complex animations, dark mode support, and seamless CRM integration.",
            tech: ["Next.js", "Framer Motion", "Tailwind", "HubSpot"],
        ...
        },
        {
            ...
            description: "Custom management portal for property listings, tenant tracking, and automated billing with interactive map integration.",
            tech: ["PHP", "Laravel", "PostgreSQL", "Google Maps"],
